    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (pessoa1.idade > pessoa2.idade)
            {
                ...
                Console.WriteLine(pessoa1.pessoa + " é mais velho que " + pessoa2.pessoa + " por " + diferencial + " anos.");
            }
            else
            {
                diferencial = pessoa2.idade - pessoa1.idade;
                Console.WriteLine(pessoa2.pessoa + " é mais velho que " + pessoa1.pessoa + " por " + diferencial + " anos.");
            }
